...
import com.paynalty.domain.toss.dto.TossUserInfoApiResponse;
...
public class TossApiClient {
    ...
    public TossApiClient(@Qualifier("tossWebClient") WebClient webClient, TossApiConfig tossApiConfig) {
        ...
        this.basicAuthHeader = "Basic " + Base64.getEncoder().encodeToString(credentials.getBytes(StandardCharsets.UTF_8)); // RESTORED
    }
    ...
    public Mono<TossTokenResponse> fetchToken(String authorizationCode, String referrer) {
        TossLoginRequest requestBody = new TossLoginRequest(authorizationCode, referrer);
