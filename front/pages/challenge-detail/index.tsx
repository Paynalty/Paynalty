...
function Page() {
    ...
    const {data: memberCounts, isLoading: isMemberCountsLoading, error: memberCountsError} = useMemberVerificationCounts(selectedChallenge?.id || '');
    ...
    return (
        <ScrollView>
            ...
            ) : Array.isArray(memberCounts) && memberCounts.length > 0 && memberCounts.some(m => m.verificationCount && m.verificationCount > 0) ? (
                    <BarChart
                        data={
            ...
            <View style={styles.rulesCard}>
                ...
                <View style={styles.gridRow}>
                    <View style={styles.gridCell}>
                        <Asset.Icon frameShape={{width: 24, height: 24}} name="icon-clock-mono"
                                    color={adaptive.grey600}/>
                    ...
                    <View style={styles.gridCell}>
                        <Asset.Icon frameShape={{width: 24, height: 24}} name="icon-repeat-mono"
                                    color={adaptive.grey600}/>
                        <Txt color={adaptive.grey600} typography="t7" fontWeight="medium">
                            인증 주기
                        </Txt>
                ...
                <View style={styles.gridRow}>
                    <View style={styles.gridCell}>
                        <Asset.Icon frameShape={{width: 24, height: 24}} name="icon-check-circle-mono"
                                    color={adaptive.grey600}/>
                        <Txt color={adaptive.grey600} typography="t7" fontWeight="medium">
                            인증 방법
                        </Txt>
