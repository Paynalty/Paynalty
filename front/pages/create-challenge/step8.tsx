...
export default function Page() {
  ...
  const displayText = invitedCount === 0 ? '아직 초대한 친구가 없어요' : `${invitedCount}명이 참여하고 있어요`;
  ...
  return (
    <>
      ...
      <Top
        title={<Top.TitleParagraph color={adaptive.grey900}>누구와 함께할까요?</Top.TitleParagraph>}
        ...
        <ListRow
          ...
          right={
            <View style={{ flexDirection: 'row', gap: -12, alignItems: 'center' }}>
              <Asset.Icon frameShape={{ width: 42, height: 42 }} name="icon-plus-grey-fill-opacity" />
            </View>
          }
        />
      </Pressable>
