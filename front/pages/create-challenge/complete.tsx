...
import {createChallenge, CreateChallengeRequestSchema, updateChallenge} from '../../src/api/challenges';
import {formatDate, formatDaysOfWeek, formatTime, getVerificationTypeLabel} from '../../src/utils/challenge';
    ...
    const handleCreateChallenge = async (option: 'tomorrow' | 'nextWeek') => {
        try {
            ...
            const payload = {
                ...
                tossIds: challengeData.invitedUsers?.map((u) => u.tossId),
            };
