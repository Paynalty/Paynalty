...
function Page() {
  ...
  return (
    <>
      ...
      <Top
        title={<Top.TitleParagraph color={adaptive.grey900}>언제까지 도전할까요?</Top.TitleParagraph>}
      ...
      <View style={{ paddingHorizontal: 16 }}>
        ...
        <View style={{ flexDirection: 'row', gap: 8 }}>
          {/* 년 선택 */}
          <Pressable onPress={() => setShowYearPicker(true)} style={{ flex: 1 }}>
          ...
          {/* 월 선택 */}
          <Pressable onPress={() => setShowMonthPicker(true)} style={{ flex: 1 }}>
            <View style={[styles.dateCard, { backgroundColor: adaptive.grey50 }]}>
              <View>
                <Txt typography="t2" color={adaptive.grey900} fontWeight="bold">
          ...
          {/* 일 선택 */}
          <Pressable onPress={() => setShowDayPicker(true)} style={{ flex: 1 }}>
            <View style={[styles.dateCard, { backgroundColor: adaptive.grey50 }]}>
              <View>
                <Txt typography="t2" color={adaptive.grey900} fontWeight="bold">
